...
class LoaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testIncludePath() {
		...
		$this->assertEquals($baseIncludePath . PS . $selfPath1, get_include_path());

		$this->object->includePath(array($selfPath2, $selfPath3));
		$this->assertEquals($baseIncludePath . PS . $selfPath1 . PS . $selfPath2 . PS . $selfPath3, get_include_path());
	}
	...
	public function testToPath() {
		...
		$this->assertEquals(APP . '/test/namespace/ClassName.php', $this->object->toPath('\test\namespace\ClassName', 'php', APP));
		$this->assertEquals(APP . '/test/namespace/Class/Name.php', $this->object->toPath('\test\namespace\Class_Name', 'php', APP));
	}

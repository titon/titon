...
use titon\Titon;
use titon\libs\storage\cache\ApcStorage;
use titon\tests\TestCase;

/**
 * Test class for titon\libs\storage\cache\ApcStorage.
 */
class ApcStorageTest extends TestCase {
	...
	public function setUp() {
		parent::setUp();
		$this->skipIf(!Titon::load('apc'), 'APC is not installed or configured properly.');

		$this->object = new ApcStorage(); // @todo
